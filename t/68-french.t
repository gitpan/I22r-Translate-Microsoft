...
my %INPUT = (
    ...
    regress1 => 'This entry was posted in {{_1}} on {{_3}}<span class="by-author"> by {{_4}}</span>.'
...
$ENV{DIAG} && diag Dumper( \%R );

#local $Data::Dumper::Indent = 1;
$ENV{DIAG} && diag("translate results ", Data::Dumper::Dumper(\%INPUT, \%R));
